...
Route::group(['middleware' => ['jwt.auth']], function () {
    ...
    Route::post('events/{eventId}/localities', [App\Http\Controllers\EventsController::class, 'storeLocalities']);
    Route::put('events/{event}/localities/{locality}', [App\Http\Controllers\EventsController::class, 'updateLocalities']);
});
