    ...
    <div class="row">
      <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 offset-xs-3 offset-sm-3 offset-md-3 offset-lg-3 text-center pt-3">
          <form class="form-signin">
              <img class="mb-2" src="http://ordenes.online/assets/images/logo.png" alt="" style="witdh:6rem;height:5rem;">
              <h1 class="h3 mb-3 font-weight-normal text-left text-dark">Hola {!! $name !!}, puedes reestablecer tu contraseña en el siguiente enlace:</h1>
              ...
              <a class="btn btn-lg btn-primary btn-block" href="{!! $url !!}" target="_blank" ><i class="fa fa-sign-in"></i> Ingresa Ahora</a>
            </form>
